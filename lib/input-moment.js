...
var InputMoment = function (_PureComponent) {
  _inherits(InputMoment, _PureComponent);
  ...
  _createClass(InputMoment, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          local = _props.local,
          props = _objectWithoutProperties(_props, ['moment', 'className', 'prevMonthIcon', 'nextMonthIcon', 'onDateSave', 'local']);
