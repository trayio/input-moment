...
var Calendar = function (_Component) {
  ...
  function Calendar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = Calendar.__proto__ || Object.getPrototypeOf(Calendar)).call.apply(_ref2, [this].concat(args))), _this), _this.selectDate = function (i, w) {
      ...
      _this.props.internalChange(m, true);
    }, _this.prevMonth = function (e) {
      e.preventDefault();
      _this.props.internalChange(_this.props.moment.subtract(1, 'month'));
    }, _this.nextMonth = function (e) {
      e.preventDefault();
      _this.props.internalChange(_this.props.moment.add(1, 'month'));
  ...
  _createClass(Calendar, [{
    ...
    value: function render() {
      ...
      var m = this.props.local ? this.props.moment.local() : this.props.moment;
      var d = m.date();
      ...
      return _react2.default.createElement(
        ...
        this.props.onDateSave ? _react2.default.createElement(
          'button',
          {
            type: 'button',
